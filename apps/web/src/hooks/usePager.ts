...
/** Paginazione a frecce (mai scrollbar) riusata da tutti i widget della
 *  Dashboard che mostrano solo una finestra di N elementi alla volta:
 *  gruppi muscolari, suggerimenti di progressione, esercizi di
 *  prossima/ultima sessione. Si blocca ai bordi, nessun wrap-around. */

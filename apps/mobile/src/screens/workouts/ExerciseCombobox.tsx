...
export function ExerciseCombobox({ value, selected, groupedCatalog, onChange }: ExerciseComboboxProps) {
          ...
          <FlatList
            ...
            renderItem={({ item: row }) =>
              row.isGroup ? (
                ...
                >
                  <Text style={[styles.optionText, row.item?.id === value && styles.optionTextSelected]}>
                    {row.label}
                  </Text>
                </TouchableOpacity>
              )

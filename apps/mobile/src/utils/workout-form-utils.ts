...
export interface ExerciseForm {
  /** Chiave stabile lato client per il riordino drag-and-drop: mai inviata
...
/** Raggruppa il catalogo per gruppo muscolare, stesso criterio della webapp
 *  (vedi apps/web/src/components/workout-form-utils.ts). */
